 ...
 */
@Autonomous(name = "Auto Loading Zone Side Red – 10s Delay", group = "Auto")
public class AutoLoadingZoneSideRed10sDelay extends LinearOpMode {

    // Timed drive section
    private static final double DRIVE_POWER = 0.35;
    private static final double TURN_POWER  = 0.25;   // positive = spin right
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Auto Loading Zone Side Red (10s delay) ready");
        telemetry.update();
