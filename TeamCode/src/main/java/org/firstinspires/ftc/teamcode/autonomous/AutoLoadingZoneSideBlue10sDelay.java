 ...
 */
@Autonomous(name = "Auto Loading Zone Side Blue – 10s Delay", group = "Auto")
public class AutoLoadingZoneSideBlue10sDelay extends LinearOpMode {

    // Timed drive section
    private static final double DRIVE_POWER = 0.35;
    private static final double TURN_POWER  = -0.25;   // negative = spin right
    ...
    // Start delay
    private static final long START_DELAY_MS = 10_000;
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Auto Loading Zone Side Blue (10s delay) ready");
        telemetry.update();
        ...
        // Reset references before encoder move
        robot.drive.resetEncoders();
        robot.drive.resetHeading();

        // 4) Back up a little with IMU hold + timeout safety
        robot.drive.driveStraightBlocking(
                this,
                BACK_UP_IN,
                DRIVE_POWER,
                BACKUP_TIMEOUT_S
